...
import com.hao.viewpageranimator.adapter.PagerAdapter;
import com.hao.viewpageranimator.adapter.PagerAdapterFactory;
    ...
    private ViewPager setupViewpager() {
        ...
        Provider<Integer> provider = new Provider<Integer>() {
            ...
            public Integer get(int position) {
                return pagerAdapter.getColor(position);
            }
        };
